...
export var URL_BASE: string = "http://localhost:4300/AngularPacienteSucursalWS/rest/";
...
/** Constantes para los tipos de registros communes - inicio*/
export var TIPOS_VIVIENDAS: number = 1;
